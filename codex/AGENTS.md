...
If it fails: confirm `GOALFY_UDS_API_KEY` exists in `~/.codex/.env` and the key shows as valid in the console at https://goalfydata.ai/settings , then fully restart again.
```
